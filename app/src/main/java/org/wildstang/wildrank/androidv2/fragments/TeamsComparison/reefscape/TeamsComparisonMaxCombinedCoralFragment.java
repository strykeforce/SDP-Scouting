...
public class TeamsComparisonMaxCombinedCoralFragment extends TeamsComparisonFragment {
        ...
        button.setOnClickListener(v -> {
            ...
            for (int i = 0; i < teams.size(); i++) {
                ...
                for (Document document : teamDocuments) {
                    ...
                    if (coral > maxCoral || (coral == maxCoral && (((int) data.get("auto_level_four") + (int) data.get("tele_level_four")) > maxLevelFour || (((int) data.get("auto_level_four") + (int) data.get("tele_level_four")) == maxLevelFour && ((int) data.get("auto_level_three") + (int) data.get("tele_level_three")) > maxLevelThree) || (((int) data.get("auto_level_four") + (int) data.get("tele_level_four")) == maxLevelFour && ((int) data.get("auto_level_three") + (int) data.get("tele_level_three")) == maxLevelThree && ((int) data.get("auto_level_two") + (int) data.get("tele_level_two")) > maxLevelTwo)))) {
                        maxCoral = coral;
                        maxLevelOne = (int) data.get("auto_level_one") + (int) data.get("tele_level_one");
                        maxLevelTwo = (int) data.get("auto_level_two") + (int) data.get("tele_level_two");
                        maxLevelThree = (int) data.get("auto_level_three") + (int) data.get("tele_level_three");
                        maxLevelFour = (int) data.get("auto_level_four") + (int) data.get("tele_level_four");
                    }
                }

                if (spinner.getSelectedItem().equals("Team Number")) {
                    barValues.add(new float[] {(float) maxLevelOne, (float) maxLevelTwo, (float) maxLevelThree, (float) maxLevelFour});
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int m = 0; m < barValues.size(); m++) {
                            if ((float) (maxLevelOne + maxLevelTwo + maxLevelThree + maxLevelFour) >= barValues.get(m)[0] + barValues.get(m)[1] + barValues.get(m)[2] + barValues.get(m)[3]) {
                                barValues.add(m, new float[] {(float) maxLevelOne, (float) maxLevelTwo, (float) maxLevelThree, (float) maxLevelFour});
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int n = 0; n < barValues.size(); n++) {
                            if ((float) (maxLevelOne + maxLevelTwo + maxLevelThree + maxLevelFour) <= barValues.get(n)[0] + barValues.get(n)[1] + barValues.get(n)[2] + barValues.get(n)[3]) {
                                barValues.add(n, new float[] {(float) maxLevelOne, (float) maxLevelTwo, (float) maxLevelThree, (float) maxLevelFour});
                ...
                max.add((float) (maxLevelOne + maxLevelTwo + maxLevelThree + maxLevelFour));
            }
            ...
            dataSet.setStackLabels(new String[] {"Max Level One", "Max Level Two", "Max Level Three", "Max Level Four"});
