...
public class TeamsComparisonAverageSpeakerFragment extends TeamsComparisonFragment {
    ...
    public void acceptNewData(List<List<Document>> allMatchDocuments) {
        ...
        button.setOnClickListener(v -> {
            ...
            for (int i = 0; i < teams.size(); i++) {
                ...
                float average = (float) speaker / (float) teamDocuments.size();
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Average Speaker");
