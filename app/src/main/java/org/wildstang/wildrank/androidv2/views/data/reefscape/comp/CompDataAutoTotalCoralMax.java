...
public class CompDataAutoTotalCoralMax extends MatchDataView implements IMatchDataView {
    public CompDataAutoTotalCoralMax(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
