...
public class CompDataAutoLevelThreeCoralAverage extends MatchDataView implements IMatchDataView {
    public CompDataAutoLevelThreeCoralAverage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
