...
public class CompDataTeleMadeAmpAverage extends MatchDataView implements IMatchDataView {
    public CompDataTeleMadeAmpAverage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
