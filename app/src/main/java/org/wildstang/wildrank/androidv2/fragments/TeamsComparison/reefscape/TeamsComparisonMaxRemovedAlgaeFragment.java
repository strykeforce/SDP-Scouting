...
public class TeamsComparisonMaxRemovedAlgaeFragment extends TeamsComparisonFragment {
    ...
    public void acceptNewData(List<List<Document>> allMatchDocuments) {
        ...
        button.setOnClickListener(v -> {
                ...
                if (spinner.getSelectedItem().equals("Team Number")) {
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int m = 0; m < barValues.size(); m++) {
                            if ((float) maxAlgae >= barValues.get(m)) {
                                barValues.add(m, (float) maxAlgae);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int n = 0; n < barValues.size(); n++) {
                            if ((float) maxAlgae <= barValues.get(n)) {
                                barValues.add(n, (float) maxAlgae);
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Max Removed Algae");
