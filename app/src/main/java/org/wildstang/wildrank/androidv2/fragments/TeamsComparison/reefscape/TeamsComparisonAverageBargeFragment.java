...
public class TeamsComparisonAverageBargeFragment extends TeamsComparisonFragment {
...
//                    }
                ...
                float average = (float) barge / (float) teamDocuments.size();
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Average Barge");
