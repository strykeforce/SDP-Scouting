...
public class TeamsComparisonMaxTotalPointsFragment extends TeamsComparisonFragment {
    ...
    public void acceptNewData(List<List<Document>> allMatchDocuments) {
        ...
        button.setOnClickListener(v -> {
                ...
                if (spinner.getSelectedItem().equals("Team Number")) {
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int m = 0; m < barValues.size(); m++) {
                            if ((float) maxPoints >= barValues.get(m)) {
                                barValues.add(m, (float) maxPoints);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int n = 0; n < barValues.size(); n++) {
                            if ((float) maxPoints <= barValues.get(n)) {
                                barValues.add(n, (float) maxPoints);
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Max Total Points");
