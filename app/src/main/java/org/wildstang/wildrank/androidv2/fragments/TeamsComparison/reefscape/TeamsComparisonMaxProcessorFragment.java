...
public class TeamsComparisonMaxProcessorFragment extends TeamsComparisonFragment {
        ...
        button.setOnClickListener(v -> {
            ...
            for (int i = 0; i < teams.size(); i++) {
                ...
                for (Document document : teamDocuments) {
                    ...
                    if (maxProcessor < (int) data.get("tele_processor")) {
                        maxProcessor = (int) data.get("tele_processor");
                    }
                }

                if (spinner.getSelectedItem().equals("Team Number")) {
                    barValues.add((float) maxProcessor);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int m = 0; m < barValues.size(); m++) {
                            if ((float) maxProcessor >= barValues.get(m)) {
                                barValues.add(m, (float) maxProcessor);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int n = 0; n < barValues.size(); n++) {
                            if ((float) maxProcessor <= barValues.get(n)) {
                                barValues.add(n, (float) maxProcessor);
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Max Processor");
