...
public class CompDataTeleProcessorAlgaeMax extends MatchDataView implements IMatchDataView {
    public CompDataTeleProcessorAlgaeMax(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
