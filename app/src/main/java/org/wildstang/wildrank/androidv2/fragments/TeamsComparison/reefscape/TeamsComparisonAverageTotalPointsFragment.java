...
public class TeamsComparisonAverageTotalPointsFragment extends TeamsComparisonFragment {
    ...
    public void acceptNewData(List<List<Document>> allMatchDocuments) {
        ...
        button.setOnClickListener(v -> {
            ...
            for (int i = 0; i < teams.size(); i++) {
                ...
                float average = (float) points / (float) teamDocuments.size();
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Average Total Points");
