...
public class CompDataTeleTotalCoralAverage extends MatchDataView implements IMatchDataView {
    public CompDataTeleTotalCoralAverage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
