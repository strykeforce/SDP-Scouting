...
public class CompDataAutoLevelFourCoralMax extends MatchDataView implements IMatchDataView {
    public CompDataAutoLevelFourCoralMax(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
