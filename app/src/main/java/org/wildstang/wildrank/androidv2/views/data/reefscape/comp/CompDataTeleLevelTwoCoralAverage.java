...
public class CompDataTeleLevelTwoCoralAverage extends MatchDataView implements IMatchDataView {
    public CompDataTeleLevelTwoCoralAverage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
