        ...
        button.setOnClickListener(v -> {
            ...
            for (int i = 0; i < teams.size(); i++) {
                ...
                for (Document document : teamDocuments) {
                    ...
                    if (maxPasses < (int) data.get("tele_passes")) {
                        maxPasses = (int) data.get("tele_passes");
                    }
                }

                if (spinner.getSelectedItem().equals("Team Number")) {
                    barValues.add((float) maxPasses);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int m = 0; m < barValues.size(); m++) {
                            if ((float) maxPasses >= barValues.get(m)) {
                                barValues.add(m, (float) maxPasses);
                    ...
                    if (barValues.size() == 0) {
                        ...
                        for (int n = 0; n < barValues.size(); n++) {
                            if ((float) maxPasses <= barValues.get(n)) {
                                barValues.add(n, (float) maxPasses);
            ...
            BarDataSet dataSet = new BarDataSet(entries, "Max Passes");
